...
//-------------------------------------------------------------------+
      ...
      if( ( DayOfWeek()== 1 && Hour()== 2 && Minute() >29 ) || ( DayOfWeek()== 4 && Hour()== 22 && Minute() >29 ) ){
    ...
    for( int g=0 ;g < OrdersTotal(); g++ ){
                        ...
                        // We select the order of index i selecting by position and from the pool of market/pending trades.
                           ...
                           if(  Minute() == 30 && LastWriteHour != Hour()   ){
                                       ...
                                       ResetLastError();
                                       filehandle = FileOpen("weekly_early_and_late_focus_data.csv",FILE_CSV|FILE_READ|FILE_WRITE);
    ...
    if( ( DayOfWeek()== 2 && Hour()== 9 && Minute() > 29 ) ||  ( DayOfWeek()== 5 && Hour()== 22 && Minute() > 29 )   ){
